...
// userscripts resolves through tools/paths.mjs::RUNTIME_BASE_REL (post-8K-5:
// "src-runtime-base"; pre-8K-5 was "scripts"). The hook is regenerated by
// `npm run hooks:install` so operators must re-install the hook after the
// 8K-5 rename for the new pathspec to take effect.
