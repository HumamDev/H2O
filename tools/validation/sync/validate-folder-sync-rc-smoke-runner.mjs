...
assertContains(helper, 'studio-launcher-extension-path-missing', 'extension path missing status');
assertContains(helper, 'studio-launcher-manifest-missing', 'extension manifest missing status');
assertContains(helper, 'studio-launcher-manifest-invalid', 'extension manifest invalid status');
