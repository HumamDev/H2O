#!/usr/bin/env node
//
// W3.4b-2.5 final pre-invocation readiness validator.
...
const evidencePath = 'release-evidence/2026-07-07/real-transport-w3-4b-2-5-pre-invocation-readiness.md';
const receiptEvidencePath = 'release-evidence/2026-07-07/real-transport-w3-4b-2-write-grade-receipt.md';
const receiptCorePath = 'release-evidence/2026-07-07/real-transport-w3-4b-2-write-grade-receipt-core.json';
...
for (const token of [
  ...
  'transportReady:true',
  'W3.4b-3 can proceed automatically',
]) {
...
mustContain(receiptEvidence, `receiptCoreHash: \`${RECEIPT_HASH}\``, 'W3.4b-2 receipt evidence hash');
mustContain(receiptEvidence, 'receiptConsumed:false', 'W3.4b-2 unconsumed receipt');
mustContain(receiptEvidence, 'receiptInvoked:false', 'W3.4b-2 uninvoked receipt');
...
console.log(JSON.stringify({
  ok: true,
  validator: 'validate-real-transport-w3-4b-2-5-pre-invocation-readiness',
  evidencePath,
