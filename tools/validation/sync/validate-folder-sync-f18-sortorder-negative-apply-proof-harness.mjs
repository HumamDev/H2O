...
if (exists(folderSyncFile)) {
  ...
  assert(!src.includes(REQUEST_SCHEMA), 'F18 design-only: proposed request schema must NOT be minted in source');
  assert(!src.includes(RECEIPT_SCHEMA), 'F18 design-only: proposed receipt schema must NOT be minted in source');
