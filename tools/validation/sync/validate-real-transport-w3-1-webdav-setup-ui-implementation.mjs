...
mustContain(rust, 'registry_parent_private_permissions', 'redacted registry parent permission output');
mustContain(rust, '"app-local"', 'app-local registry path source');
mustContain(rust, '"env"', 'env registry path source');
mustContain(rust, '"default-private-legacy"', 'legacy registry path source');
mustContain(rust, '"invalid"', 'invalid registry path source');
mustContain(rust, 'APP_LOCAL_DESCRIPTOR_REGISTRY_FILE_NAME', 'app-local registry filename');
mustContain(rust, 'write_grade_registry_source_candidate', 'write-grade registry source candidate helper');
...
mustContain(ui, 'registry parent private', 'redacted registry parent permission status');
...
mustContain(ui, 'result && result.registryParentPrivatePermissions', 'registry parent permission render');
