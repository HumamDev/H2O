...
assertNotIncludes(studioHtml, 'real-transport-approval.js', 'B8 must not be wired into studio.html');
assertNotIncludes(packStudio, 'real-transport-approval.js', 'B8 must not be wired into pack-studio');
