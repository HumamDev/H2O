...
function runProjection(source, overrides = {}) {
  ...
  vm.runInContext(`
    ...
    ${extractFunction(CORE_SOURCE, 'chatAtlasMountedTurnSections')}
    ${extractFunction(CORE_SOURCE, 'chatAtlasNativePathSections')}
    ${extractFunction(CORE_SOURCE, 'chatAtlasTurnsByQId')}
    ${extractFunction(CORE_SOURCE, 'chatAtlasNativeDiagnosticsCacheKey')}
