...
const nativeMirrorPath = path.join(repoRoot, 'src-runtime-base/0F0g.⬛️🗂️ Tag Provider Core 🗂️.js');
const studioMirrorPath = path.join(repoRoot, `${SURFACES_BASE_REL}/studio/S0F0g. 🎬 Tag Provider Core - Studio.js`);
