// ==H2O Module==
// @h2o-id             0f0f.category_provider_core
// @name               0F0f.⬛️🗂️ Category Provider Core 🗂️
// @namespace          H2O.Premium.CGX.category_provider_core
// @author             HumamDev
// @version            1.0.0
// @revision           001
// @build              260515-000001
// @description        Phase 4B — native runtime copy of the shared pure CategoryProvider catalog/assignment/override logic. Publishes window.H2O.Library.CategoryProviderCore. Body is byte-identical to shared/library/category-provider-core.js and to the Studio mirror surfaces/studio/S0F0f. Loads before later category runtime delegation phases.
// @match              https://chatgpt.com/*
// @run-at             document-idle
// @grant              none
// ==/H2O Module==

// MIRROR — body must match shared/library/category-provider-core.js and
// surfaces/studio/S0F0f. exactly. Edit the canonical in shared/ first,
