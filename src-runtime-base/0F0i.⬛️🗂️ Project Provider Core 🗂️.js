// ==H2O Module==
// @h2o-id             0f0i.project_provider_core
// @name               0F0i.⬛️🗂️ Project Provider Core 🗂️
// @namespace          H2O.Premium.CGX.project_provider_core
// @author             HumamDev
// @version            1.0.0
// @revision           001
// @build              260516-000001
// @description        Phase 6B - native runtime copy of the shared pure ProjectProvider catalog/cache/binding logic. Publishes window.H2O.Library.ProjectProviderCore. Body is byte-identical to shared/library/project-provider-core.js and to the Studio mirror surfaces/studio/S0F0i. Loads before later project runtime delegation phases.
// @match              https://chatgpt.com/*
// @run-at             document-idle
// @grant              none
// ==/H2O Module==

// MIRROR - body must match shared/library/project-provider-core.js and
// surfaces/studio/S0F0i. 🎬 Project Provider Core - Studio.js exactly. Edit the canonical in shared/ first,
// then copy the IIFE body into both mirrors.
