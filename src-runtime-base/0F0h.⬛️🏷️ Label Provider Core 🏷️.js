// ==H2O Module==
// @h2o-id             0f0h.label_provider_core
// @name               0F0h.⬛️🏷️ Label Provider Core 🏷️
// @namespace          H2O.Premium.CGX.label_provider_core
// @author             HumamDev
// @version            1.0.0
// @revision           001
// @build              260515-000001
// @description        Phase 5C - native runtime copy of the shared pure LabelProvider catalog/binding logic. Publishes window.H2O.Library.LabelProviderCore. Body is byte-identical to shared/library/label-provider-core.js and to the Studio mirror surfaces/studio/S0F0h. Loads before later label runtime delegation phases.
// @match              https://chatgpt.com/*
// @run-at             document-idle
// @grant              none
// ==/H2O Module==

// MIRROR - body must match shared/library/label-provider-core.js and
// surfaces/studio/S0F0h. 🎬 Label Provider Core - Studio.js exactly. Edit the canonical in shared/ first,
