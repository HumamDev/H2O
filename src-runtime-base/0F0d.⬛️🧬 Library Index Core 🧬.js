// ==H2O Module==
// @h2o-id             0f0d.library_index_core
// @name               0F0d.⬛️🧬 Library Index Core 🧬
// @namespace          H2O.Premium.CGX.library_index_core
// @author             HumamDev
// @version            1.0.0
// @revision           001
// @build              260515-000020
// @description        Phase 2B — native runtime copy of the shared pure Library Index merge/normalize/facet/count logic. Publishes window.H2O.Library.LibraryIndexCore. Body is byte-identical to shared/library/library-index-core.js and to the Studio mirror surfaces/studio/S0F0d. — keep the three in sync. Loads at 0F0d so it precedes 0F1c (native Library Index) at boot.
...
// surfaces/studio/S0F0d. exactly. Edit the canonical in shared/ first, then
// copy the body here. Phase 3 will replace this duplication with a proper
