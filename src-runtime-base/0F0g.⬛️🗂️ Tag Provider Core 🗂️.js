// ==H2O Module==
// @h2o-id             0f0g.tag_provider_core
// @name               0F0g.⬛️🗂️ Tag Provider Core 🗂️
// @namespace          H2O.Premium.CGX.tag_provider_core
// @author             HumamDev
// @version            1.0.0
// @revision           001
// @build              260515-000001
// @description        Phase 5B - native runtime copy of the shared pure TagProvider catalog/binding/occurrence logic. Publishes window.H2O.Library.TagProviderCore. Body is byte-identical to shared/library/tag-provider-core.js and to the Studio mirror surfaces/studio/S0F0g. Loads before later tag runtime delegation phases.
// @match              https://chatgpt.com/*
// @run-at             document-idle
// @grant              none
// ==/H2O Module==

// MIRROR - body must match shared/library/tag-provider-core.js and
// surfaces/studio/S0F0g. 🎬 Tag Provider Core - Studio.js exactly. Edit the canonical in shared/ first,
