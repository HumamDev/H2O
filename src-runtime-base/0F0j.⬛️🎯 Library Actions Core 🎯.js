// ==H2O Module==
// @h2o-id             0f0j.library_actions_core
// @name               0F0j.⬛️🎯 Library Actions Core 🎯
// @namespace          H2O.Premium.CGX.library_actions_core
// @author             HumamDev
// @version            1.0.0
// @revision           001
// @build              260520-000001
// @description        Phase 7B - native runtime copy of the shared pure LibraryActionsCore action contract/planning logic. Publishes window.H2O.LibraryActionsCore and window.H2O.Library.LibraryActionsCore. Body is byte-identical to shared/library/library-actions-core.js and to the Studio mirror surfaces/studio/S0F0j. Loads before later LibraryActions facade delegation phases.
// @match              https://chatgpt.com/*
// @run-at             document-idle
// @grant              none
// ==/H2O Module==

// MIRROR - body must match shared/library/library-actions-core.js and
// surfaces/studio/S0F0j. 🎬 Library Actions Core - Studio.js exactly. Edit the
// canonical in shared/ first, then copy the IIFE body into both mirrors.
