// ==H2O Module==
// @h2o-id             0f0e.folder_provider_core
// @name               0F0e.⬛️🗂️ Folder Provider Core 🗂️
// @namespace          H2O.Premium.CGX.folder_provider_core
// @author             HumamDev
// @version            1.0.0
// @revision           001
// @build              260515-000001
// @description        Phase 3B — native runtime copy of the shared pure FolderProvider catalog/binding logic. Publishes window.H2O.Library.FolderProviderCore. Body is byte-identical to shared/library/folder-provider-core.js and to the Studio mirror surfaces/studio/S0F0e. Loads before later folder runtime delegation phases.
...
// surfaces/studio/S0F0e. exactly. Edit the canonical in shared/ first,
