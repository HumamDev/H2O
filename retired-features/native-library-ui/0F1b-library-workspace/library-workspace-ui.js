/*
 * R4.7.5 retired Native Library Workspace UI archive.
 *
 * Source: src-runtime-base/0F1b.⬛️🗂️ Library Workspace 🗂️.js
 * Destination: retired-features/native-library-ui/0F1b-library-workspace/library-workspace-ui.js
 *
 * Block 1 of 6 — R4.6.3 workspace body-attribute + CSS gate (pre-R4.7.5 lines 108-196).
 * Block 2 of 6 — R4.6.1 deprecation banner (pre-R4.7.5 lines 198-265).
 * Block 3 of 6 — Library sidebar button + prepaint/layout UI (pre-R4.7.5 lines 956-2468).
 * Block 4 of 6 — Workspace CSS renderer (pre-R4.7.5 lines 2469-2784).
 * Block 5 of 6 — /library route, native navigation guard, page host, and workspace renderers (pre-R4.7.5 lines 2800-3658).
 * Block 6 of 6 — Workspace read-model fallback, route/event bindings, public UI API, and boot wiring (pre-R4.7.5 lines 3666-4881).
 *
 * The full original file is preserved below so rollback can restore
 * the pre-R4.7.5 Native Library Workspace UI exactly. Live 0F1b now
 * keeps only diagnostics and no-op compatibility APIs.
 */
