// ==UserScript==
// @h2o-id             s0f0d.library_index_core.studio
// @name               S0F0d. 🎬 Library Index Core - Studio
// @namespace          H2O.Premium.CGX.library_index_core.studio
// @author             HumamDev
// @version            1.0.0
// @revision           001
// @build              260515-000021
// @description        Phase 2B — Studio runtime copy of the shared pure Library Index merge/normalize/facet/count logic. Publishes window.H2O.Library.LibraryIndexCore. Body is byte-identical to shared/library/library-index-core.js and to the native mirror scripts/0F0d. Loads before S0F1c (Studio Library Index) so the shared module is available at boot.
// @match              https://chatgpt.com/*
// @run-at             document-idle
// @grant              none
// ==/UserScript==

// MIRROR — body must match shared/library/library-index-core.js and
// scripts/0F0d. exactly. Edit the canonical in shared/ first, then copy the
// body here. Phase 3 will collapse this duplication with a proper shared
// loader pipeline.
