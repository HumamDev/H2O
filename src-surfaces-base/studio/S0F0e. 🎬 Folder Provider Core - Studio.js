// ==UserScript==
// @h2o-id             s0f0e.folder_provider_core.studio
// @name               S0F0e. 🎬 Folder Provider Core - Studio
// @namespace          H2O.Premium.CGX.folder_provider_core.studio
// @author             HumamDev
// @version            1.0.0
// @revision           001
// @build              260515-000001
// @description        Phase 3B — Studio runtime copy of the shared pure FolderProvider catalog/binding logic. Publishes window.H2O.Library.FolderProviderCore. Body is byte-identical to shared/library/folder-provider-core.js and to the native mirror scripts/0F0e. Loads before later folder runtime delegation phases.
// @match              https://chatgpt.com/*
// @run-at             document-idle
// @grant              none
// ==/UserScript==

// MIRROR — body must match shared/library/folder-provider-core.js and
// scripts/0F0e. exactly. Edit the canonical in shared/ first, then copy the
// IIFE body into both mirrors.
