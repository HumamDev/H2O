...
(function (global) {
  ...
  async function syncNow(payload) {
    ...
    return baseResult('syncNow', {
      ...
      chatFolderBindingReceiptExport: safeObject(result.chatFolderBindingReceiptExport),
      ...
      chatFolderBindingRequestImport: safeObject(result.chatFolderBindingRequestImport),
      chatFolderBindingRequestAutoApply: safeObject(result.chatFolderBindingRequestAutoApply),
      chatFolderBindingReceiptImport: safeObject(result.chatFolderBindingReceiptImport),
