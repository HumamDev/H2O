// ==UserScript==
// @h2o-id             s0f0c.library_registry_core.studio
// @name               S0F0c. 🎬 Library Registry Core - Studio
// @namespace          H2O.Premium.CGX.library_registry_core.studio
// @author             HumamDev
// @version            1.0.0
// @revision           001
// @build              260515-000011
// @description        Phase 2A — Studio runtime copy of the shared pure Chat Registry merge/normalize logic. Publishes window.H2O.Library.RegistryCore. Body is byte-identical to shared/library/chat-registry-core.js and to the native mirror scripts/0F0c. Loads before S0F1g (Studio Chat Registry) so the shared module is available at boot.
...
// scripts/0F0c. exactly. Edit the canonical in shared/ first, then copy the
