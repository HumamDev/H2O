...
| B1 | Native `src-runtime-base/3H1a` parallel cleanup (drop UTIL_storage IIFE, GM_*, legacy keys; share canonical key) | complete + runtime-validated |
