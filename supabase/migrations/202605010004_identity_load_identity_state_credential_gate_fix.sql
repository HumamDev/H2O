-- Identity Phase 3.8E fix: make the read-only restore RPC explicitly return
-- the safe password credential gate state for every authenticated caller.
-- This is intentionally read-only and does not create or update password status.
